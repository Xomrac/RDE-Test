...
namespace XomracCore.DialogueSystem
{
    public class DialogueDisplayer : MonoBehaviour
    {
        ...
        public void ShowDialogue(DialoguePlayer player)
        {
            ...
            _continueButton.onClick.AddListener(() => _currentPlayer.ContinueDialogue());
        ...
        private void ShowChoices(BeatNodeData beat)
        {
            ...
            for (int i = 0; i < _choiceButtons.Length; i++)
            {
                ...
                _choiceButtons[i].onClick.AddListener(() => _currentPlayer.ContinueDialogue(displayedValue));
            }
        }
